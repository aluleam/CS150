...
// calculate the percentage of capacity and ticket revenue.
// **********************************************************
...
int main(void)
{
    ...
    display_report(available_seats,tickets_sold,capacity_pct,
                  cost_per_ticket,ticket_revenue);
