...
void calc_subtotal(double goods_and_labor, int pct_discount, double* ptr_discount_amt, double* ptr_subtotal);
void calc_total(double subtotal, double* ptr_tax, double* ptr_total);
...
//***************************************************************************
void calc_subtotal(double goods_and_labor, int pct_discount,
                   double* ptr_discount_amt, double* ptr_subtotal)
{

    *ptr_discount_amt = goods_and_labor * (pct_discount / 100.0);
    *ptr_subtotal = goods_and_labor - *ptr_discount_amt;
...
void calc_total(double subtotal, double* ptr_tax, double* ptr_total)
{
    *ptr_tax = subtotal * (TAX_RATE / 100.0);
    *ptr_total = subtotal + *ptr_tax;
}   //End calc_total
